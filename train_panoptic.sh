...
EXP_DIR="/mrtstorage/users/rehman/experiments/c2e_encoding/loss_v1/x65_b6_c0.5_further/"
mkdir -p "${EXP_DIR}"
...
python "${WORK_DIR}"/train_panoptic.py \
    ...
    --num_clones=2 \
    --tf_initial_checkpoint="/mrtstorage/users/rehman/experiments/c2e_encoding/loss_v1/x65_b6_c0.5_b1/model.ckpt-69648" \
