...
EXP_DIR="/mrtstorage/users/rehman/experiments/c2e_encoding/loss_v1/m3l_b3_c0.5_o1"
mkdir -p "${EXP_DIR}"
...
python "${WORK_DIR}"/train_panoptic.py \
  ...
  --tf_initial_checkpoint="/mrtstorage/users/rehman/trained_models/deeplab_mnv3_small_cityscapes_trainfine/model.ckpt" \
